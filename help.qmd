...
Since we are working with 10^3 combinations, it is possible to overly-split signatures. Consequently, for any unmixing control we are showing only signatures that compromised more than 1% of the population whose main detector aligned with the single color (vs. the autofluorescence)
